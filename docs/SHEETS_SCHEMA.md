...
- `avatar_url`: foto de perfil retornada pela identidade Google validada; vazio para contas sem foto Google
...
- `video_url`: aceita links de YouTube/Shorts, Twitch, Vimeo, TikTok, Kick, Facebook e Instagram. Outros domínios são bloqueados.
