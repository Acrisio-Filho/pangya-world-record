...
- **Saída:** `infrastructure/google-apps-script.js` encapsula acesso à planilha, hash, sessões e validação de tokens Google. Nenhum objeto `SpreadsheetApp` é entregue aos módulos.
